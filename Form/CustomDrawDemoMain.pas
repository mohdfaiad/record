...
uses
  ...
  cxControls, cxSchedulerStorage, ExtCtrls, ComCtrls,
  cxSchedulerUtils, 
  cxGeometry, cxLookAndFeelPainters, 
  cxSchedulerTreeListBrowser,
  cxSchedulerRibbonStyleEventEditor, cxClasses, dxSkinsCore, dxSkinBlack,
  ...
  dxSkinscxSchedulerPainter, dxSkinVS2010, DemoBasicMain, cxGraphics, cxStyles,
  cxEdit, Dialogs, cxScheduler, cxSchedulerHolidays, cxSchedulerTimeGridView,
  cxSchedulerWeekView, cxSchedulerYearView, cxSchedulerGanttView,
  cxSchedulerRecurrence, StdCtrls;
...
uses
  cxDateUtils, dxOffice11, cxFormats;
...
procedure TCustomDrawDemoMainForm.AddEvent;
begin
...
procedure TCustomDrawDemoMainForm.SchedulerContentPopupMenuPopup(
  Sender: TcxSchedulerContentPopupMenu; ABuiltInMenu: TPopupMenu;
  var AHandled: Boolean);
var
  AItem: TMenuItem;
begin
  inherited;
  AItem := NewItem('新建事件', scNone, False, True, N1111Click, 0, '');
  AItem.ImageIndex := 0;
...
procedure TCustomDrawDemoMainForm.N1111Click(Sender: TObject);
begin
  inherited;
