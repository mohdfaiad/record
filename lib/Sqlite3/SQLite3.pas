...
//扩展两个加密函数
function sqlite3_key (Db: TSQLiteDB;Key: PAnsiChar;KeySize: Integer): integer;  cdecl; external SQLiteDLL name 'sqlite3_key';
function sqlite3_rekey (Db: TSQLiteDB;Key: PAnsiChar;KeySize: Integer): integer;  cdecl; external SQLiteDLL name 'sqlite3_rekey';
// 
